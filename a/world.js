...
export class World {
    ...
    canTrade(entity1, entity2) {
        ...
        // An entity can give a resource if they have a surplus AND it's a need for the other entity.
        const entity1CanGive = Object.keys(entity1Has).filter(r => entity1Has[r] > 2 && entity2Needs.includes(r) && !entity1.tradeInventory.getAmount(r));
        const entity2CanGive = Object.keys(entity2Has).filter(r => entity2Has[r] > 2 && entity1Needs.includes(r) && !entity2.tradeInventory.getAmount(r));
